 ...
 * Adapter class that uses a CursorAdapter to display data in a RecyclerView.
                    Abstract
 */
public abstract class RecyclerViewCursorAdapter<T extends RecyclerViewCursorAdapter.RecyclerViewCursorViewHolder> extends RecyclerView.Adapter<T> {
    /**
    ...
    public static abstract class RecyclerViewCursorViewHolder extends RecyclerView.ViewHolder {
