...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    protected void onPostExecute(String[] result) {
        LogUtil.logMethodCalled();
        List<String> newList = Arrays.asList(result);
        mForecastAdapter.swapData(newList);
    }
...
// Now we have a String representing the complete forecast in JSON Format.
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                int i = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cvArray);
            }
...
/*        // These are the names of the JSON objects that need to be extracted.
        ...
        SharedPreferences sharedPrefs =
                PreferenceManager.getDefaultSharedPreferences(forecastFragment.getActivity());
        String unitType = sharedPrefs.getString(
                forecastFragment.getString(R.string.pref_temp_key),
                forecastFragment.getString(R.string.pref_temp_metric));
